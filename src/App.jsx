 ...
 */
const App = ({ handleLogout, history, route }) => (
      ...
      <nav className="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
        ...
        <ul className="nav nav-pills flex-column sidebar-nav">
          <li className="nav-item">
            <a href="#dasboard" className="nav-link"><em className="oi oi-dashboard" />Dashboard</a>
          </li>
          <li className="nav-item">
            <a href="#dasboard" className="nav-link"><em className="oi oi-key" />Rooms</a>
          </li>
          <li className="nav-item">
            <a href="#dasboard" className="nav-link"><em className="oi oi-list" />Categories</a>
          </li>
          <li className="nav-item">
            <a href="#dasboard" className="nav-link"><em className="oi oi-badge" />Hall of Fame</a>
          </li>
        </ul>
      </nav>
        ...
        <header className="page-header row justify-center">
          ...
          >
            <a
              ...
              aria-expanded="false"
            >
              <img className="circle float-left profile-photo" src="https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" alt="Open Menu" height={50} />
